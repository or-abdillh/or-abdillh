	...
	<main class="navbar">
		<section class="navbar-brand">
			<div class="flex items-center gap-3">
				...
				<h1 class="text-gray-50 text-xl font-semibold lg:text-3xl">OR ABDILLH</h1>
			</div>
...
<style scoped>
	.navbar {
		@apply z-20 md:flex md:items-center md:justify-between md:px-6 md:py-8 lg:px-10 w-full bg-gradient-to-r from-blue-600 to-sky-600 fixed top-0 left-0 right-0 px-5 lg:py-8 py-3;
	}
	...
	.navbar-menu {
		@apply duration-300 fixed md:relative top-0 bottom-0 bg-blue-500 md:bg-opacity-0 px-5 lg:px-0 pt-12 md:pt-0;
	}
